...
function construction_landing_page_customizer_theme_info( $wp_customize ) {
	...
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Demo', 'construction-landing-page' ) . ': </label><a href="' . esc_url( 'https://demo.rarathemes.com/construction-landing-page/' ) . '" target="_blank">' . __( 'here', 'construction-landing-page' ) . '</a></span><br />';
