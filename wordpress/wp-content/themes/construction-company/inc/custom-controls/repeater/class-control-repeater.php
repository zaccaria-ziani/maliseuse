...
if( ! class_exists( 'Construction_Company_Control_Repeater' ) ) {
    ...
    class Construction_Company_Control_Repeater extends WP_Customize_Control {
        ...
        public function enqueue() {  
            ...
            wp_enqueue_script( 'repeater', get_stylesheet_directory_uri() . '/inc/custom-controls/repeater/repeater.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-sortable' ), false, true );
            wp_enqueue_style( 'repeater-css', get_stylesheet_directory_uri() . '/inc/custom-controls/repeater/repeater.css', null );
        }
        ...
        protected function render_content() {
            ...
            <?php if ( isset( $this->choices['limit'] ) ) : ?>
                <p class="limit"><?php printf( esc_attr__( 'Limit: %s rows', 'construction-company' ), esc_html( $this->choices['limit'] ) ); ?></p>
            <?php endif; ?>
                        ...
                        <# _.each( data, function( field, i ) { #>
                            ...
                            <div class="repeater-field repeater-field-{{{ field.type }}}">
                                ...
                                <# } else if ( 'color' === field.type ) { #>
                                    ...
                                    <label>
                                        ...
                                        <# if ( field.description ) { #>
                                            <span class="description customize-control-description">{{{ field.description }}}</span>
                                        <# } #>
                                        <input class="color-picker-hex" type="text" maxlength="7" placeholder="<?php echo esc_attr__( 'Hex Value', 'construction-company' ); ?>"  value="{{{ field.default }}}" data-field="{{{ field.id }}}" {{ defaultValue }} />
                                ...
                                <# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
                                    ...
                                    <figure class="kirki-image-attachment" data-placeholder="<?php echo esc_attr( 'No Image Selected', 'theme-slug' ); ?>" >
                                        <# if ( field.default ) { #>
                                ...
                                <# } else if ( field.type === 'upload' ) { #>
                                    ...
                                    <figure class="kirki-file-attachment" data-placeholder="<?php echo esc_attr( 'No File Selected', 'theme-slug' ); ?>" >
                                        <# if ( field.default ) { #>
